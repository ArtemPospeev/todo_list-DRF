...
class TestProjectAPI(APITestCase):
    ...
    def test_patch_project_admin(self):
        ...
        self.assertNotEqual(blended_project.repo_link, updated_project_obj.repo_link)
    ...
    def test_delete_project_admin(self):
        ...
        updated_active_projects_count = Project.objects.filter(deleted=False).count()
        updated_projects_count = Project.objects.count()

        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
        self.assertEqual(projects_count, updated_projects_count)
        self.assertNotEqual(active_projects_count, updated_active_projects_count)
